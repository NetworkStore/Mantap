...
echo -e "$y===========================================================================$wh"
echo -e "$m      MENU UTAMA $m"      ┃      OTHER MENU $m"     
echo -e "$y==========================================================================$wh"
echo -e "$yy 1$wh.  SSH&OpenVPN$wh"  ┃ "$yy 13$wh. SLOWDNS MENU (OFF)$wh"   
echo -e "$yy 2$wh.  L2TP$wh"         ┃ "$yy 14$wh. CEK SEMUA IP PORT$wh"
echo -e "$yy 3$wh.  PPTP$wh"         ┃ "$yy 15$wh. CEK SEMUA SERVICE VPN$wh"
echo -e "$yy 4$wh.  SSTP$wh"         ┃ "$yy 16$wh. UPDATE MENU (Update)$wh"
echo -e "$yy 5$wh.  WIREGUARD$wh"    ┃ "$yy 17$wh. sl-fix Error SSLH+WS-TLS after reboot$wh"
echo -e "$yy 6$wh.  SHADOWSOCKS$wh"  ┃ "$yy 18$wh. Settings (Pengaturan)$wh"
echo -e "$yy 7$wh.  SHADOWSOCKSR$wh" ┃ "$yy 19$wh. Exit (Keluar)$wh"
echo -e "$yy 8$wh.  XRAY VMESS$wh"   ┃ "$yy 20$wh. copyrepo (Salin Repo Script Mantap)$wh"
echo -e "$yy 9$wh.  XRAY VLESS$wh"   ┃ "$yy 21$wh. menuinfo$wh"
echo -e "$yy 10$wh. XRAY TROJAN$wh"  ┃ "$yy 22$wh. Shadowsocks Plugin (Buat Akun)$wh"
echo -e "$yy 11$wh. TROJAN GO$wh"    ┃
echo -e "$yy 12$wh. XRAY GRPC$wh"    ┃
echo -e "$y==========================================================================$wh"
